							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										...
										<li><a href="package_type_add.php">Package type add</a></li>
						...
						<div class="col-md-12">
							...
							?>
								...
								<ul style="list-style:none;padding-left:0px;">
								 ...
								 <hr>
								<div class="row">
									<div class="col-md-6 content" style="text-align:justify;">
										<?php echo $res['description']; ?>
									</div>
									<div class="col-md-6">
										<div class="row">
											<?php
											$getImg = $package->getPackageImageById($pack_id);
											if ($getImg) {
